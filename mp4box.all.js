/* 	MP4Box模块,提取自115Master-0.5.0.js
	版本v0.7
	部分功能需要https环境才能正常工作
	MP4Box.js支持渐进式解析MP4文件：
	1、获取MP4文件信息（如持续时间、轨道类型等）。
	2、利用Media Source Extensions (MSE) 对MP4文件进行分割。
	3、提取MP4文件中的样本创建TextTracks。 */
	...
	const MP4Box = getDefaultExportFromCjs(mp4box_allExports);